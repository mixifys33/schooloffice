...
export interface TeacherListProps {
  ...
  /** ID of teacher being deleted (for loading state) */
  deletingTeacherId?: string
                    ...
                    >
                      ...
                      <td className="py-3 px-4 hidden sm:table-cell">
                        {teacher.hasSystemAccess ? (
                          <Badge className="bg-[var(--info-light)] text-[var(--info-dark)] dark:bg-[var(--info-dark)] dark:text-[var(--info)] text-xs">
                            Has Access
                          </Badge>
                        ) : (
                          <Badge className="bg-[var(--bg-surface)] text-[var(--text-secondary)] dark:bg-[var(--border-default)] dark:text-[var(--text-muted)] text-xs">
                            Record Only
                          </Badge>
                        )}
                      </td>
                        ...
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {onDelete && (
                            <Button
                              ...
                              size="sm"
                              disabled={deletingTeacherId === teacher.id}
                              className="text-red-600 hover:text-red-700 hover:bg-red-50 dark:text-red-400 dark:hover:text-red-300 dark:hover:bg-red-950 disabled:opacity-50"
                              onClick={(e) => {
                                e.stopPropagation()
                                onDelete(teacher)
                              }}
