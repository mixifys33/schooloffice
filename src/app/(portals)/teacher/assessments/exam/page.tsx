...
/**
 * Exam Entry Page for Teacher Portal
...
function ExamEntryPageContent() {
    ...
    async function fetchExamData() {
      ...
      try {
        const response = await fetch(
          `/api/teacher/assessments/exam?classId=${selectedClassId}&subjectId=${selectedSubjectId}`
        )
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/teacher/assessments/exam/scores', {
        method: 'POST',
  ...
  const handleSubmitFinal = async () => {
    ...
    try {
      ...
      if (hasChanges) {
        ...
        await fetch('/api/teacher/assessments/exam/scores', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            examId: examData.examEntry.id,
      ...
      // Submit final scores
      const response = await fetch('/api/teacher/assessments/exam/submit', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          examId: examData.examEntry.id,
