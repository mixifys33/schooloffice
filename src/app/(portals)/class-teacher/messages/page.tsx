...
import { ArrowLeft, MessageSquare, Users, Mail } from 'lucide-react'
...
export default function ClassTeacherMessagesPage() {
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className={cn(cardStyles.base, cardStyles.compact, 'mt-4')}>
        <div className="flex items-center gap-4">
          <div className={cn('p-3 bg-[var(--info-light)] dark:bg-[var(--info-dark)] rounded-lg', teacherColors.info.bg)}>
            <MessageSquare className={cn('h-6 w-6', teacherColors.info.text)} />
          </div>
          <div>
      ...
      <Card className={cn(cardStyles.base, cardStyles.normal, 'mt-6')}>
        <CardHeader>
          <CardTitle className={cn(typography.sectionTitle)}>Messaging Center</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className={cn(typography.body, 'text-[var(--text-secondary)] dark:text-[var(--text-muted)] mb-4')}>
              This section will allow you to send messages to students and parents.
            </p>
            <Link href="/class-teacher">
              <Button>
