...
export async function GET(request: NextRequest) {
  try {
    ...
    // Calculate revenue (total payments collected for this term)
    ...
    // Calculate total expected fees and collected for this term
    ...
    // Get payment methods breakdown for this term
