/**
 * Super Admin - Bulk Reactivate Schools
...
interface BulkReactivateRequest {
  schoolIds: string[]
  reason: string
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const body: BulkReactivateRequest = await request.json()
    ...
    for (const schoolId of schoolIds) {
      try {
        ...
        console.error(`Error reactivating school ${schoolId}:`, schoolError)
    ...
    return NextResponse.json({
      success: true,
      message: `Bulk reactivate completed: ${successCount} succeeded, ${failureCount} failed`,
      data: {
    ...
    return NextResponse.json(
      {
        ...
        message: 'Failed to process bulk reactivate',
