...
export async function POST(request: NextRequest) {
  try {
    console.log('🔍 [API] /api/teacher/assessments/ca/scores - POST - Starting request')
    ...
    console.log(`✅ [API] /api/teacher/assessments/ca/scores - Successfully updated ${successCount} scores`)
    ...
    console.error('❌ [API] /api/teacher/assessments/ca/scores - Error:', error)
