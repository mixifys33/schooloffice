...
export async function DELETE(
  ...
  try {
    console.log('🔍 [API] /api/class-teacher/assessments/ca/[id] - DELETE - Starting request')
    ...
    console.log(`✅ [API] /api/class-teacher/assessments/ca/[id] - Successfully deleted ${deleteResult.count} CA entries`)
    ...
    console.error('❌ [API] /api/class-teacher/assessments/ca/[id] - DELETE - Error:', error)
...
export async function PATCH(
  ...
  try {
    console.log('🔍 [API] /api/class-teacher/assessments/ca/[id] - PATCH - Starting request')
    ...
    console.log(`✅ [API] /api/class-teacher/assessments/ca/[id] - Successfully updated ${updateResult.count} CA entry statuses`)
    ...
    console.error('❌ [API] /api/class-teacher/assessments/ca/[id] - PATCH - Error:', error)
