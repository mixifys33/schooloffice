...
export async function POST(request: NextRequest) {
  try {
    console.log('🔍 [API] /api/class-teacher/assessments/ca/submit - POST - Starting request')
    ...
    console.log(`✅ [API] /api/class-teacher/assessments/ca/submit - Successfully submitted ${updateResult.count} CA entries`)
    ...
    console.error('❌ [API] /api/class-teacher/assessments/ca/submit - Error:', error)
