/**
 * Communication Hub Cost Report API Route
 * Requirements: 8.4
 */
...
/**
 * POST /api/admin/communication-hub/reports/cost
 * Generates a cost report with cost analysis by channel and school
...
export async function POST(request: NextRequest) {
  try {
    ...
    const report = await hubReportService.generateCostReport(params)
