  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-slate-100">Message Logs</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
              <select
                ...
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-md text-slate-300 text-sm"
              >
        ...
        <CardContent className="p-0">
          {loading ? (
                          ...
                          <tr className="bg-slate-700/20">
                            <td colSpan={8} className="py-4 px-4">
                              <div className="space-y-3">
                                <div>
                                  <h4 className="text-sm font-medium text-slate-200 mb-2">Full Content</h4>
                                  <div className="bg-slate-900/50 rounded p-3 text-xs text-slate-300 whitespace-pre-wrap">
                                    {log.content}
                                  </div>
                                </div>
                                {log.deliveredAt && (
                                  <div>
                                    <span className="text-xs text-slate-400">Delivered at: </span>
                                ...
                                {log.errorMessage && (
                                  <div>
                                    ...
                                    <div className="bg-red-950/30 border border-red-800/50 rounded p-2 text-xs text-red-300">
                                      {log.errorMessage}
                                    </div>
                                  </div>
                                )}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-slate-400 text-lg mb-2">No messages found</p>
