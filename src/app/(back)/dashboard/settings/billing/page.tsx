    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {paymentSuccess && (
        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
          ...
          <p className="text-green-800">Payment initiated successfully! Your features will be restored shortly.</p>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
        ...
        {subscription?.featuresRestricted && (
          <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-sm text-red-800 font-medium">Restricted Features:</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button
              ...
              className="p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg className="h-8 w-8 mx-auto mb-2 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
