...
async function main() {
  ...
  // Check 4: DOS navigation consistency
  total++;
  if (checkFileContent('src/components/dos/dos-navigation.tsx', '/dashboard/dos/curriculum/subjects', 'DOS navigation uses consistent paths')) {
    passed++;
  }
